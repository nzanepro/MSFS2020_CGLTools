...
# ---------------------------------------------------------------------------
# This branch also ships a byte-for-byte copy of bingtile.py under
# oldscripts/bingtile.py (used by the oldscripts/*.py DEM-splitting
# scripts). Confirm it really is identical so the above coverage applies
# to it too, rather than silently drifting out of sync.
# ---------------------------------------------------------------------------

def test_oldscripts_bingtile_is_identical_to_root_bingtile():
    import filecmp
    import os
    root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    assert filecmp.cmp(os.path.join(root, "bingtile.py"),
                       os.path.join(root, "oldscripts", "bingtile.py"),
                       shallow=False)
